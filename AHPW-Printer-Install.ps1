# *********************************************************************
# Install Script: AHP Printer West
# Target Printer: AHP Printer West
# IP Address: 10.10.3.207
#
# Expected driver: HP Smart Universal Printing (V3) (v2.07.1)
# *********************************************************************

$DriverModel = "HP Smart Universal Printing (V3) (v2.07.1)"
$PrinterName = "AHP Printer West"
$PortName    = "IP_10.10.3.207"
$PortAddress = "10.10.3.207"
