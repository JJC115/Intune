# *********************************************************************
# Install Script: HRT Printer #1
# Target Printer: HRT Printer #1
# IP Address: 10.10.3.204
#
# Expected driver: HP Smart Universal Printing (V3) (v2.07.1)
# This script downloads the repository ZIP from GitHub,
# extracts the HP folder, and then installs the driver (if needed)
# and creates the printer "HRT Printer #1" on port "IP_10.10.3.204".
# *********************************************************************

$DriverModel = "HP Smart Universal Printing (V3) (v2.07.1)"
$PrinterName = "HRT Printer #1"
$PortName    = "IP_10.10.3.204"
$PortAddress = "10.10.3.204"

# --- Download & Extract HP Folder from GitHub ---
...
# --- Check for Driver; Run Installer if Needed ---
...
# --- Check for Printer; Add if Missing ---
