# *********************************************************************
# Install Script: AHP Printer East
# Target Printer: AHP Printer East
# IP Address: 10.10.3.206
#
# Expected driver: HP Smart Universal Printing (V3) (v2.07.1)
# *********************************************************************

$DriverModel = "HP Smart Universal Printing (V3) (v2.07.1)"
$PrinterName = "AHP Printer East"
$PortName    = "IP_10.10.3.206"
$PortAddress = "10.10.3.206"
